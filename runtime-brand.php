...
foreach (['login.php','index.php','connect.php','reset.php','install.php'] as $page) {
    ...
    $html = preg_replace('~<link\b[^>]*href=["\']/assets/brand/(?:brand|mobile-shell|integrations-v2|integrations-ui-v4|integrations-ui-v5|integrations-ui-v6)\.css[^"\']*["\'][^>]*>~i', '', $html) ?? $html;
