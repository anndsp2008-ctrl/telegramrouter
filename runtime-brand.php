...
$headBrand = '<link rel="stylesheet" href="/assets/brand/brand.css?v=1">'
    ...
    .'<link rel="stylesheet" href="/assets/brand/integrations-ui-v5.css?v=1">'
...
foreach (['login.php','index.php','connect.php','reset.php','install.php'] as $page) {
    ...
    $html = preg_replace('~<link\b[^>]*href=["\']/assets/brand/(?:brand|mobile-shell|integrations-v2|integrations-ui-v4|integrations-ui-v5)\.css[^"\']*["\'][^>]*>~i', '', $html) ?? $html;
