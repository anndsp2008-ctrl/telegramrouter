...
<section class="treatment-block tmr-smart-format-choice" aria-labelledby="smart-format-title">
  ...
  <p class="field-help">A análise original será preservada. A tradução seguirá a configuração desta regra. Se a IA ou o card falhar, a mensagem NÃO será encaminhada sem formatação; a falha será registrada para nova tentativa.</p>
</section>
HTML;
    $index=$replaceOne($index,
