...
namespace {
    ...
    foreach([
        ...
        [['translation_enabled'=>1,'translation_provider'=>'openai'],['openai','workers_ai']],
        ...
        [['translation_enabled'=>0,'translation_provider'=>'openai'],['openai','workers_ai']]
    ] as [$rule,$expected]){
    ...
    if(!str_contains($source,'foreach($providers as $provider)')||
       ...
       !str_contains($source,'elseif($provider===\'openai\')')||
